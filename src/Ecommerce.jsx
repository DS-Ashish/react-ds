        ...
        <section class="Solution-banner hero-1 hero">
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-6">
                <img
                  src="assets/img/n/Dynamics-ecommerce-Banner.png"
                  alt="image"
                />
              </div>
            </div>
        ...
        <section>
          <div class="container">
            <header class="section-header">
              <h3>
                Microsoft Dynamics 365 For <br />
                Ecommerce
              </h3>
              <p>
                Take your business toward a productive route by implementing
                Microsoft Dynamics 365 for Ecommerce. Streamline your processes,
                manage your customers seamlessly, predict sales, and make
                informed decisions.
                <br /> <br />
