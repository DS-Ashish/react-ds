  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Improve customer’s experience and organization & processes with Dynamics 365 AI (Artificial Intelligence). Schedule a free Dynamics 365 AI demo today."
        />
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <img src="assets/img/AI-Banner.png" alt="AI-Banner" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="container">
          <header className="section-header">
            <h3>Dynamics 365 AI Features</h3>
            <p>
          ...
          <div className="row">
            <div className="col-md-7">
              <div className="commen-lef-pic">
                <img
                  src="assets/img/hero_913x513_2x.png"
                  alt="hero_913x513_2x"
                />
              </div>
            </div>
            <div className="col-md-5">
              <div class="commen-rit-info">
                <h3>Get Dynamics 365 AI</h3>
                <p>
