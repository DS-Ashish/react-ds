            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6 mobile-1">
                     ...
                     <h2>Extend Your Business Capabilities by Establishing Secure Connection Between Your Devices and Azure IoT Apps.</h2>
                     <div>
                  ...
                  <div className="col-lg-6">
                     <img src="assets/img/Dynamics-IoT-Banner.webp" alt="Dynamics-IoT-Banner" />
                  </div>
               </div>
            </div>
         ...
         <section>
            <div className="container">
               <header className="section-header">
                  <h3>Deliver A Flexible, Scalable Solution <br />That Adapts To Your Needs & Processes.</h3>
                  <p>Streamline your supply chain, avoid production delays and equipment downtime, ensure quality delivery, and remotely monitor your<br />devices & service equipment all through by implementing Azure IoT intelligence in your business.</p>
               </header>
                     ...
                     <div className="accordion" id="accnew">
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/icons-azure_cloud-embed.svg" alt="icons-azure_cloud-embed" /></div><span>Azure IoT hub</span>
                                 </button>
                              </h2>
                           ...
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/icons-azure_agile.svg" alt="icons-azure_agile" /></div><span>Azure IoT Central</span>
                                 </button>
                              </h2>
                           ...
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fin3" aria-expanded="false" aria-controls="fin3">
                                 <div className='wr-in'><img src="assets/img/icons-azure_project-management.svg" alt="icons-azure_project-management" /></div><span>Azure Sphere</span>
                                 </button>
                              </h2>
                              <div id="fin3" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div className="accordion-body">
                     ...
                     <div className="accordion" id="accneww">
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/icons-azure_innovation.svg" alt="icons-azure_innovation" /></div><span>Azure Digital Twins</span>
                                 </button>
                              </h2>
                           ...
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/icons-azure_security.svg" alt="icons-azure_security" /></div><span>Azure IoT Edge</span>
                                 </button>
                              </h2>
                           ...
                           <div className="accordion-item">
                              <h2 className="accordion-header" id="headingTwo">
                                 <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fin6" aria-expanded="false" aria-controls="fin6">
                                 <div className='wr-in'><img src="assets/img/icons-azure_machine-learning.svg" alt="icons-azure_machine-learning" /></div><span>Azure Machine Learning</span>
                                 </button>
                              </h2>
                              <div id="fin6" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accneww">
                                 <div className="accordion-body">
                  ...
                  <div className="col-lg-7">
                     <div className="row gx-4">
                        <div className="col-lg-6">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Optimize <br />Supply Chain</h3>
                                 <div className="overlay"></div>
                                 <p>Optimize your supply chain by monitoring and regulating in real-time. Stay updated with inventory levels, warehousing flow, product delivery, and more to ensure continuity.</p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Improve <br />Production Flow</h3>
                                 <div className="overlay"></div>
                                 <p>Get notified whenever there is a moisture or temperature imbalance, so that you can intervene in production to maintain product quality standards while minimizing waste.</p>
                              </div>
                           </div>
                        </div>
                        <div className="col-lg-6 top-m">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Reduce <br />Equipment Downtime</h3>
                                 <div className="overlay"></div>
                                 <p>With Dynamics 365 and Azure IoT, get notified whenever outage threshold gets exceeded so that to drive production rescheduling or equipment can be sent for maintenance.</p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Reduce <br />Production Delays</h3>
                                 <div className="overlay"></div>
                                 <p>Compare actual production cycle time with the planned one. With Microsoft IoT Suite, get notified when your production is on schedule and when you need to interrupt production.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="row">
                        <div className="col-md-8">
                           <div className="call_to_action-left">
                              ...
                              <p>Discuss with our experts, we can suggest a best-in-class IoT solution for your business.</p>
                        ...
                        <div className="col-lg-4">
                           <div className="call_to_action-right call_to_action-right-t"><img src="assets/img/Group-683.png" alt="image" /></div>
                        </div>
                     </div>
                    </div>
                    {/* <div className="swiper-slide">
               ...
               <div className="row">
                  ...
                  <div className="col-lg-6">
                     <div className="side-heading">
                        ...
                        <p>We offer a full range of IoT services to support you on your Dynamics journey including implementation, upgrade and support.</p>
                     </div>
                     <div className="busine_service_bottom-right">
                        ...
                        <div className="card_new_content">
                           ...
                           <p>Start uplifting your business with our Dynamics 365 and Microsoft IoT implementation.</p>
                     ...
                     <div className="busine_service_bottom-right">
                        ...
                        <div className="card_new_content">
                           <h3>Upgrade</h3>
                           <p>Continuously grow and scale your business with our optimum IoT support services.</p>
                           <div className="action-content"><NavLink to="#">Get Started</NavLink></div>
                        </div>
                     </div>
                     <div className="busine_service_bottom-right">
                        ...
                        <div className="card_new_content">
                           <h3>Support</h3>
                           <p>Integrate IoT and Dynamics 365 to upgrade and level-up your system capabilities.</p>
                           <div className="action-content"><NavLink to="#">Get Started</NavLink></div>
                        </div>
                     </div>
                  </div>
               ...
               <div className="col-lg-6">
                  ...
                  <div className="col-lg-6">
                     ...
                     <div className="blogs-extra-right">
                        <ul>
                           <li><NavLink to="#"><i className="bi bi-box-arrow-up-right"></i> Microsoft Azure IoT manufacturing solutions</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-box-arrow-up-right"></i> IoT for Earth: helping farmers grow a brighter future for us all</NavLink></li>
