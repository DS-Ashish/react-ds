        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <img
                src="assets/img/azure-machine-learning-banner.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-machine-learning_Automated-Machine-Learning-.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-machine-learning_Easy-to-Use-Functionality-.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-machine-learning_High-End-Security-.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-machine-learning_Seamless-Integration-.svg"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-machine-learning_Hybrid-Multi-Cloud-Support-.svg"
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        leverage integrated tools along with optimal support for
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        processes, debug model errors, and ensure model accuracy
                        for responsible ML solutions.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
                      ...
                      <div className="overlay"></div>
                      <p>
                        Innovate and drive on a highly secured hybrid platform.
                        Effectively run all your ML workloads anywhere while
                        following the built-in global compliance and governance.
                      </p>
                    </div>
                  </div>
                </div>
