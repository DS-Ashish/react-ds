      ...
      <section>
        <div className="container">
          <header className="section-header">
            <h3>What is Azure Azure Digital Twins?</h3>
            <p>
            ...
            <br /> <br />
            <h3>Azure Digital Twins Overview</h3>
            <p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              <h3>
                Model Your IoT Connected Environment Leveraging Azure Digital
                Twins
              </h3>
              <h4>Azure Digital Twins Features</h4>
                  ...
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        representation. The live representation can be leveraged
                        to reveal business analytics, equipment performance, and
                        more in real-time.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Get inputs from connected devices and systems to connect
                        your IoT devices, Logic Apps, and REST APIs to make an
                        efficient connected environment to optimize processes
                        and predict device performance.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
                      ...
                      <div className="overlay"></div>
                      <p>
                        Implement scalable solutions quickly with reduced coding
                        efforts leveraging Plug & Play app that allows
