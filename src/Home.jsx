        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              ...
              <h2>
                You focus on your business. We'll streamline your business
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                ...
                <div className="bnner_inline_images">
                  <ul>
                    <li>
                      <lottie-player
                        src="https://assets1.lottiefiles.com/private_files/lf30_nxupqbkn.json"
              ...
              <div className="banner-service-wraper">
                <ul className="list-n fist-m">
                  ...
                  <li>
                    <div className="list-n-wrp">
                      <a href="#">
                        <img src="assets/img/azur-icons.svg" alt="azur-icons" />
                        <span>Azure</span>
                      </a>
                    </div>
                  </li>
                ...
                <ul className="list-n  fist-m-3">
                  ...
                  <li className="list-n-wrp-size">
                    <div className="list-n-wrp">
                      <a href="#">
                        <img src="assets/img/ds-365.png" alt="ds-365" />
                      </a>
                    </div>
                  </li>
                  <li>
                  ...
                  <div className="square2">
                    <div className="square-container2">
                      <div className="align-center">
                        <h3 className="textshadow">Startup</h3>
                        <p>
                          With Microsoft Dynamics Business Solutions, startups
                          can streamline their business efficiency and ensure
                          levelling up their business in a shorter time span.
                        </p>
                      </div>
                      <a
                        href="#"
                    ...
                    <div className="casestudys-slider-item">
                      <div className="profile mt-auto">
                        ...
                        <div className="case-button">
                          <a href="#" className="btn btn-md btn-custom-1">
                            Downlad Now
                          </a>
                        </div>
                      </div>
