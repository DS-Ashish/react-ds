    ...
    <>
     <section id="hero" className="hero hero-1">
         <div className="container">
            <div className="row">
               <div className="col-lg-6">
                  <h1 data-aos="fade-up" >UK's Leading<br />
                     Microsoft Dynamics 365 <br />Partner
                  </h1>
                  <h2 >You focus on your business. We'll streamline your business processes through Microsoft Business Applications.</h2>
      ...
      <section id="services" className="services">
         <div className="container" data-aos="fade-up">
            <header className="section-header">
               <h3>Power Your Business With<br />
      ...
      <section id="services" className="services hero-1 hero">
         <div className="container" data-aos="fade-up">
            <header className="section-header">
               <h3>Become an Industry leader</h3>
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">Startup</h3>
                                 <p>With Microsoft Dynamics Business Solutions, startups can streamline their business efficiency and ensure levelling up their business in a shorter time span.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
                        </div>
                     </div>
                     ...
                     <div className="square-flip">
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">Not for Profit</h3>
                                 <p> Our experienced Dynamics consultants in the UK can help to streamline your end-to-end non-profit practices across your organization or divisions.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
                     ...
                     <div className="square-flip">
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">E-Commerce</h3>
                                 <p>Automate your entire e-commerce operations from ordering and inventory management to supply chain efficiency to final customer delivery with Dynamics 365 E-commerce.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
                     ...
                     <div className="square-flip">
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">Manufacturing & Distribution</h3>
                                 <p>By eliminating redundancies, our experts in the United Kingdom can boost efficiency in your manufacturing &amp; distribution model through D365 Business Applications.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
                     ...
                     <div className="square-flip">
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">Professional Services</h3>
                                 <p>We help to automate and streamline your professional services from managing finances, customers, and clients to projects while reducing costs and equipping efficiency.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
                     ...
                     <div className="square-flip">
                        ...
                        <div className='square2'>
                           <div className="square-container2">
                              <div className="align-center">
                                 <h3 className="textshadow">Food & Beverages</h3>
                                 <p>We deep-dive your industry-specific needs and implement a next-generation Microsoft D365 Solution delivering true values to your food &amp; beverages business domain.</p>
                              </div>
                              <a href="#" target="_blank" className="boxshadow kallyas-button">Learn More</a>
                           </div>
                           <div className="flip-overlay"></div>
      ...
      <section  className="Health-Check">
         <div className="container">
            <header className="section-header">
               ...
               <p>Enlarge your business capabilities and ensure your business <br />continuity with our Dynamics 365 system health check program.</p>
            </header>
            <div className="row">
               ...
               <div className="col-lg-6 pt-4 pt-lg-0 content"  >
                  ...
                  <ul>
                     <li>Considering your present business requirements and future business anticipations, we diagnose your real-time requirements demonstrating your future approach.</li>
                     <li>Consultants at Dynamics Square provide free system health-check to discover the optimum and customized Microsoft Dynamics 365 needs as per your distinct business context.</li>
                     <li>Now, it's time to decide whether you want to stay with your existing equipped system or would love to schedule a Microsoft Dynamics Demo to implement a modern-equipped system.</li>
                  </ul>
                  <a href="#" className="read-more" data-aos="fade-left" data-aos-delay="500">Get Free System Health Check <i className="bi bi-long-arrow-right"></i></a>
               </div>
            </div>
         </div>
      </section>
         ...
         <div className="container" data-aos="fade-up">
            <div className="row  gy-4">
               ...
               <div className="col-lg-6" >
                  ...
                  <div className="casestudys-slider swiper" >
                     <div className="swiper-wrapper">
                        <div className="swiper-slide">
                           <div className="casestudys-slider-item">
                              <div className="profile mt-auto">
                                 ...
                                 <div className="case-button">
                                    <a href="#" className="btn btn-md btn-custom-1">Downlad Now</a>
                                 </div>
                              </div>
                           </div>
                        </div>
