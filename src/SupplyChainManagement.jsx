...
<>
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6 mobile-1">
                     <h1>Dynamics 365 <br />Supply Chain Management
                     
                     </h1>
                     <h2>Explore new Supply Chain capabilities, optimize resources, maximize operational efficiency, and accelerate time to market while keeping real-time eyes in your end-to-end supply chain operations.</h2>
                     <div>
                  ...
                  <div className="col-lg-6">
                     <img src="assets/img/banner-supply-chain-management.svg" alt="image" />
                  </div>
               </div>
            </div>
         ...
         <section>
            <div className="container">
               <header className="section-header">
                  ...
                  <p>Bring a unified view of your entire supply chain cycle from inventory, warehousing, manufacturing, logistics, and more along <br />with predictive data to support instant and strategic decision-making. Microsoft Dynamics 365 Supply Chain helps organizations simplify, streamline, and accelerate their supply chain practices just to produce, drive, and scale high.</p>
               </header>
                     ...
                     <div class="accordion" id="accnew">
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Budget.svg" alt="icons" /></div><span>Accelerate Time to Market</span>
                                 </button>
                              </h2>
                              <div id="fin1" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div class="accordion-body">
                                 With Dynamics 365 Supply Chain Management, accelerate time to market, simplify your order management, and seamlessly manage & resolve product quality issues to improve customer satisfaction.
                                 </div>
                              </div>
                           </div>
                           <hr />
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Financials-3.svg" alt="icons" /></div><span>Demand Analysis & Fulfillment</span>
                                 </button>
                              </h2>
                           ...
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Budget.svg" alt="icons" /></div><span>Optimize Inventory & Logistics</span>
                                 </button>
                              </h2>
                              <div id="fin3" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div class="accordion-body">
                                 Drive omnichannel inventory with real-time access, automate your logistics and warehousing processes, simplify your procurement management, and estimate accurate landed costs with D365 Supply Chain Management.
                                 </div>
                              </div>
                           </div>
                  ...
                  <div className='col-lg-6'>
                     ...
                     <div class="accordion" id="accnew">
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#fin3" aria-expanded="false" aria-controls="fin3">
                                 <div className='wr-in'><img src="assets/img/Project.svg" alt="icons" /></div><span>Intelligent Manufacturing Operations </span>
                                 </button>
                              </h2>
                              <div id="fin3" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div class="accordion-body">
                                 Bring agility and scalability in your manufacturing processes, minimize errors, and drive business continuity even in remote locations by implementing Dynamics Supply Chain module embedded with AI, IoT, and Mixed Reality.
                                 </div>
                              </div>
                           </div>
                           <hr />
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/International-Accounting-3.svg" alt="icons" /></div><span>Increase Asset Uptime</span>
                                 </button>
                              </h2>
                              <div id="fin4" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div class="accordion-body">
                                 Automate resource scheduling, reduce machine downtime, and proactively manage critical supply chain operations by applying predictive maintenance, and improving equipment effectiveness all through D365 Supply Chain Solutions.
                                 </div>
                              </div>
                           </div>
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-5 m--t">
                     <h3>Why Dynamics <br />365 Supply Chain Management?
                      </h3>
                     
                     <h4>Microsoft Dynamics 365 Supply Chain Management Features
                     </h4>
                  ...
                  <div className="col-lg-7">
                     <div className="row gx-4">
                        <div className="col-lg-6">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Automate & <br />Unify Operations </h3>
                                 <div className="overlay"></div>
                                 <p>Bring automation in your entire supply chain pipeline to accelerate processes while reducing redundant tasks. Streamline operations with a unified data view of inventory, manufacturing, warehousing, logistics, and more.</p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Drive Innovation <br />& Scalability  
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>Maximize operational efficiency, optimize your workforce productivity, drive scalability by bringing transparency in your supply chain cycle from ordering, warehousing, forecasting to inventory management and automation. .</p>
                              </div>
                           </div>
                        </div>
                        <div className="col-lg-6 top-m">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Drive Strategic<br /> Planning
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>With Microsoft 365 Supply Chain Management, turn your supply chain and logistics data into predictive analytics to make informed decisions and drive strategic planning for better revenue outcomes. </p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Optimize<br /> Resources 
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>Keep tracking your inventory levels, improve cost management, predict customer demand, and enable better resource and inventory planning to drive productive growth while reducing downtime and eliminating redundancies. </p>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="row">
                        <div className="col-md-8">
                           <div className="call_to_action-left">
                              <h3>Create an intelligent and adaptable <br />supply chain
                              </h3>
         ...
         <section id="pricing" className="pricing">
            <div className="container">
               <header className="section-header">
                  <h3>Supply Chain Management Pricing
                  </h3>
                  <p>Build a consistent and flexible supply chain by our Dynamics 365 Supply Chain Management Packages</p>
               </header>
               <div className="row gy-4 p-9">
                  ...
                  <div className="col-lg-6 col-md-6">
                     <div className="box box-22">
                        ...
                        <ul>
                           <li>Build Resilience with an Agile Supply Chain with Dynamics 365. Enhance Customer Service. Drive Business Sales. Manage Topline Revenue. Market Smarter. Services: Cloud-Based CRM, Customer Support, Automate Sales, Marketing Features.</li>
                        </ul>
               ...
               <div className="row justify-content-center">
                  <div className="col-lg-8">
                     <div className="call-to-action-content">
                        ...
                        <p>Drive new business challenges by implementing Dynamics 365 Supply Chain Management</p>
               ...
               <div className="row top-2 gx-5">
                  ...
                  <div className="col-lg-6">
                     ...
                     <div className="blogs-extra-right">
                        <ul>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Nucleus Research Report 2019</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>The top 8 Trends Every COO Should Know</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>The Savvy Leader’s Guide to Building Intelligent Supply Chain</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Creating an Agile Supply Chain</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>A Quick-Start Guide for Improving Supply Chain Resilience</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Risk Mitigation Across Today’s Supply Chain</NavLink></li>
                     ...
                     <div className="accordion accordion-flush" id="faqlist1">
                        ...
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-2" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              Considering the rapid changes in the industry, increasing customer demand, and continuously evolving market competitions, businesses are required to implement a solution to streamline and automate their supply chain operations.<br /><br />
                              Initially, you can manage your operations manually. Once your business starts growing, you need to support your business continuity with smart business solutions like Microsoft Dynamics 365 Supply Chain Management – a cloud-based solution to seamlessly roll out your supply chain efficiency.<br /><br />
                        ...
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-4" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              Dynamics 365 Supply Chain Management comes with several business-driven features that help to manage the entire supply chain practices with real-time data-driven capability. Here is the list of D365 Supply Chain Management features:<br /><br />
                              <ul>
                        ...
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-5" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              When you can automate your data and streamline your practices while reducing costs and eliminating data redundancies, it can help you bring a smoother flow across your supply chain processes. <br /><br />
                              D365 Supply Chain Management can help your enterprise to bring real-time data efficiency across your supply chain pipeline from managing inventories, to warehousing, to logistics management, procurement to service, and transportation management. <br /><br />
                        ...
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-7" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              Microsoft Dynamics 365 Supply Comes with a number of modules to support your business flow and bring continuity in your supply chain pipeline with real-time access into each process. <br /><br />We understand you could have a different set of practices or flow in your supply chain, thereby Microsoft’s supply chain solution comes with the flexibility that can be customized according to your business suite and configured or integrated to support your current as well as futuristic needs.<br /><br />If you want to discuss what sort of customization, integration, or configuration can be performed addressing your custom supply chain process, connect with Dynamics Square.
                              </div>
                           </div>
                        </div>
                     </div>
