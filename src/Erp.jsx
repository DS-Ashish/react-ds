    ...
    <>
      ...
      <section className="Solution-banner hero-1 hero">
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-332">
              <h1>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-commerce.svg"
                            alt="icons-commerce"
                          />
                        </div>
                        <span>Commerce</span>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_finance-1.svg"
                            alt="icons_finance-1"
                          />
                        </div>
                        <span>Finance</span>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_HR-management-1.svg"
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_manufacturing-1.svg"
      ...
      <section className="hero hero-1 hero-33 hero-99">
        <div className="container">
          <div className="row pad9x rever-1">
            <div className="col-lg-7">
              <div className="commen-lef-pic">
                <img src="assets/img/Dynamics-NAV.png" alt="Dynamics-NAV" />
              </div>
            </div>
          ...
          <div className="row pad9x">
            ...
            <div className="col-lg-7">
              <div className="commen-lef-pic">
                <img src="assets/img/ax.png" alt="ax" />
              </div>
            </div>
          </div>
