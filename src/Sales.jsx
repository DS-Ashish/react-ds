...
<>
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6 mobile-1">
                     ...
                     <h2>Upgrade your system with Microsoft Dynamics 365 Sales to impact your sales drive and improve sound customer relationships to elevate your business values while maximizing your revenue outcomes.</h2>
                     <div>
         ...
         <section>
            <div className="container">
               <header className="section-header">
                  ...
                  <p>Microsoft Dynamics 365 for Sales (formerly known as Dynamics CRM) helps to improve end-to-end sales practices, build & improve <br />your customer relationship, and supports to close sales deals faster. With actionable sales insights configured for mobile devices, it helps to make instant productive decisions, engage customers, and drive effective sales strategy.</p>
               </header>
                     ...
                     <div class="accordion" id="accnew">
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/sales-hub-app.svg" alt="icons" /></div><span>Sales Hub App</span>
                                 </button>
                              </h2>
                              <div id="fin1" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accnew">
                                 <div class="accordion-body">
                                 Developed on unified interface framework configured with responsiveness that facilitates users with interactive app view and navigation for any screen or device. The Sales Hub app is designed to be used by both desktops and mobile devices and comes with Microsoft Dynamics 365 Sales Enterprise Plan.
                                 </div>
                              </div>
                           </div>
            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-5 m--t">
                     <h3>Why Implement Microsoft Dynamics 365 Sales for Your Business?
                     </h3>
                     
                     <h4>Dynamics 365 For Sales Features
                     </h4>
                  ...
                  <div className="col-lg-7">
                     <div className="row gx-4">
                        <div className="col-lg-6">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Build & Improve <br />Customer Relationship </h3>
                                 <div className="overlay"></div>
                                 <p>With a unified view of interactions and real-time engaging facilitation, connect, engage, and build customer relationships. Identify whom and how to engage to drive conversions.</p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Collaborate & <br />Engage Faster
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>Gain visibility into the right data insights, collaborate with your sales team in real-time, and manage your end-to-end sales pipeline leveraging a single collaborated workspace.</p>
                              </div>
                           </div>
                        </div>
                        <div className="col-lg-6 top-m">
                           <div className="why-solution-wrapper">
                              <div className="why-solution-wrapper-inner">
                                 <h3>Close <br />Sales Faster
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>Leveraging AI-based insights, connect and engage with the right customers across communication channels. Meet and collaborate with your customers virtually to close sales faster.</p>
                              </div>
                              <div className="why-solution-wrapper-inner">
                                 <h3>Make Informed <br />Decisions
                                 </h3>
                                 <div className="overlay"></div>
                                 <p>With AI-based data-driven practices, automate your sales and marketing practices and make informed decisions to enable and drive continuous productivity. </p>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="row">
                        <div className="col-md-8">
                           <div className="call_to_action-left">
                              ...
                              <p>Discuss and reveal a business solution best suited to your specific sales processes.</p>
               ...
               <div className="row">
                  ...
                  <div className="col-lg-6">
                     <div className="side-heading">
                        ...
                        <p>We offer a full range of services to support you on your Dynamics 365 Sales journey including implementation, upgrade and support.
                        </p>
                     </div>
                     <div className="busine_service_bottom-right">
         ...
         <section id="pricing" className="pricing">
            <div className="container">
               <header className="section-header">
                  <h3>Dynamics 365 Sales Pricing
                  </h3>
                  <p>Choose The Applications That Are Right For Your Business Needs. </p>
               </header>
               <div className="row gy-4 p-9">
                  <div className="col-lg-4 col-md-4">
                     {/* <div className="box">
                       ...
                       <div className="box box-22">
                        <h4>Dynamics 365 Sales<br />
                        Professional
                        </h4>
                        <div className="price"><sup>£</sup>49<span>Per-User/Per Month</span></div>
                        <ul>
                           <li> Core sales force automation and Microsoft 365 integration</li>
                        </ul>
                  ...
                  <div className="col-lg-4 col-md-4">
                     ...
                     <h4>Dynamics 365 Sales<br />
                        ...
                        <ul>
                           <li>Industry-leading sales force automation with contextual insights and advanced customisation capabilities</li>
                        </ul>
                  ...
                  <div className="col-lg-4 col-md-4">
                     {/* <div className="box">
                       ...
                       Premium
                        ...
                        <div className="price"><sup>£</sup>101.80<span>Per-User/Per Month</span></div>
                        <ul>
                           <li> Dynamics 365 Sales Enterprise plus prebuilt customisable intelligence solutions for sellers and managers</li>
                        </ul>
               ...
               <div className="row top-2 gx-5">
                  ...
                  <div className="col-lg-6">
                     ...
                     <div className="blogs-extra-right">
                        <ul>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>6 Strategies to Boost Sales Productivity</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Building Relationships in Today’s Sales Environment</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Dynamics 365 Sales Professional</NavLink></li>
                           <li><NavLink to="#"><i className="bi bi-file-earmark-pdf"></i>Key Capability of Dynamics 365 Sales</NavLink></li>
...
With Dynamics 365 Sales, everyone involved in the Sales process can access data and manage customers from anywhere and at any time using mobile or tab devices. To know how Dynamics 365 sales can help to improve your customer experience and impact your sales drive, contact experts at Dynamics Square. 
                        ...
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-5" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              Addressing your specific business needs and a number of user requirements, your licensing need for Dynamics 365 Sales may go different. To know your exact licensing cost, connect with Dynamics Square. Here, we are giving a rough idea of licensing to implement Dynamics 365 Sales considering the most common licensing model:<br /><br />
                              <b>Dynamics 365 Sales Professional</b><br /><br />
                              <ul>
                                 <li>For first Dynamics 365 App – 49 pounds/ per user (approx.)</li>
                                 <li>For Subsequent Dynamics 365 App – 15 pounds/per user (approx.)</li>
                              </ul>
                              <b>Dynamics 365 Sales Enterprise</b><br /><br />
                              <ul>
                                 <li>For First Dynamics 365 App – 71.60 Pounds/per user (approx.)</li>
                                 <li>For Subsequent Dynamics 365 App – 15 pounds/per user (approx.)</li>
                              </ul>
                              <b>Dynamics 365 Sales Premium </b><br /><br />
                              <ul>
                                 <li>For First Dynamics 365 App – 101.80 Pounds/per user.</li>
                              </ul>
                              </div>
                           </div>
                        </div>
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-6" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              Dynamics 365 Sales helps to transform your entire sales model. It enables businesses to improve and uplift their digital sales experience. They can connect and engage the actual customers in real-time. With centralized data, Dynamics 365 Sales enables people to collaborate and process the same customer data in real-time which helps to streamline and accelerate sales.<br /><br />Instant sales reports and other actionable insights help everyone in the sales team to make informed decisions in real-time as Dynamics 365 sales eliminate the need for manual data processing and repetitive tasks.<br /><br />When you get handy with sales insights and customer behavior in real-time, it helps convert the leads and close the sales faster. Sales managers can monitor and control the sales process and can suggest supporting the ongoing sales process or campaign.<br /><br />With predictive insights, salespeople can manage sales, customers, and can determine their priorities to impact and accelerate sales and profitability.
                              </div>
                           </div>
                        </div>
                        <div className="accordion-item">
                           ...
                           <div id="faq-content-6" className="accordion-collapse collapse" data-bs-parent="#faqlist1">
                              <div className="accordion-body">
                              All you need to sign in to your Microsoft 365 account in your Sales Professional App, now select Microsoft 365 App launcher, and then Dynamics 365. The selection of the app entirely depends on the subscription you have availed of.<br /><br />Now, select Sales Professional on Dynamics 365 Home Page and you are ready to navigate according to your need leveraging the Navigation bar, Site map, Data records, and other business practices available in your Dynamics 365 Sales Professional.<br /><br />To know further how to efficiently make use of Microsoft Dynamics Sales features, contact Dynamics Square today, our Dynamics 365 sales experts can assist you.
                              </div>
                           </div>
                        </div>
                     </div>
