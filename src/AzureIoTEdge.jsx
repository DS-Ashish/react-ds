                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        windows-based devices that ensures supporting container
                        engines.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Designed with free and open-source code and comes under
                        the MIT license that enables code flexibility and
                        provides more control to customize your code according
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        Docker-compatible containers provided by Azure services
                        or authorized Microsoft partners.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
                      ...
                      <p>
                        ...
                        cloud and deploy the same while eliminating the need of
                        touching the devices physically.
                      </p>
                    </div>
                  </div>
                </div>
