  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              ...
              <h4>What are Power Apps Features</h4>
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        professional software developers. Bring more efficiency
                        and accuracy to solve business problems with PowerApps
                        pre-built templates, AI components that require low code
                        or minimal code.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Take advantage of more than 200+ connectors to integrate
                        data and systems you already use. Extend Power Apps
                        further as a professional developer with custom
      ...
      <section id="pricing" className="pricing">
        <div className="container">
          <header className="section-header">
            <h3>Microsoft Power Apps Pricing</h3>
            <p>
