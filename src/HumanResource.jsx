        ...
        <div className="container">
          <header className="section-header">
            ...
            <p>
              ...
              Microsoft Dynamics 365 Talent) is designed to boost your <br />{" "}
              resourcing capabilitiesand manage your entire workforce to produce
              better results. It helps to hire the right talent, onboard <br />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              ...
              <h4>Microsoft Dynamics 365 Human Resources Features</h4>
                ...
                <div className="col-lg-6">
                  <div className="why-solution-wrapper">
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Enterprises can optimize their human resource practices,
                        improve employee engagement, and manage end-to-end HR
                        tasks embedded with AI insights that drive growth and
                        sustainability.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Automate HR administration, streamline HR process flow,
                        and easily integrate with third-party HR solutions to
                        improve your business performance while ensuring
                        security, privacy, and compliance part.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
                ...
                <div className="row">
                  <div className="col-lg-8">
                    <div className="call_to_action-left">
                      <h3>Microsoft Dynamics 365Human Resources</h3>
                      <p>
                        We are here to understand your requirement and convert
                        it into valuable solutions to simplify and seamlessly
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="side-heading">
                ...
                <p>
                  Manage your workforce, maximize resource utilization, bring
                  organizational agility, engage and onboard the right talent,
                  leverage valuable AI insights to craft a better workspace with
              ...
              <div className="busine_service_bottom-right">
                ...
                <div className="card_new_content">
                  ...
                  <p>
                    ...
                    your organization with our Dynamics 365 support services.
                  </p>
                  <div className="action-content">
                    <NavLink to="#">Get Started</NavLink>
                  </div>
