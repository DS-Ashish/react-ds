          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6  mobile-1">
                <h1>About Us</h1>
                <h2>
                  Learn about Dynamics Square and explore what make us unique
                  and one of the leading Dynamics 365 Business Central Partners
                  in London, UK.{" "}
                </h2>
              </div>
              <div class="col-lg-6">
              ...
              <div className="col-lg-6">
                <div className="mission-content">
                  <div className="mission-inner-con">
                    ...
                    <h4>Our Mission</h4>
                    <p>
                      To empower every individual and organization in the region
                      to achieve more through Microsoft Business Application
                      Suite.
                    </p>
                  </div>
                ...
                <div className="domain-expertise-left">
                  ...
                  <div className="domain-Expertise-list">
                    <ul>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Enterprise
                          Resource Planning
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Customer
                          Relationship Management
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Business
                          Intelligence
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> IoT
                          Deployment
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Supply Chain
                          Management
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Financial
                          Management
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Project
                          Operations
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="bi bi-arrow-right-circle"></i> Human
                          Resource Management
                        </a>
                      </li>
                    </ul>
