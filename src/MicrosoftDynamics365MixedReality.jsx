        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <img src="assets/img/Mixed-Reality.png" alt="Mixed-Reality" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row">
            <div className="col-lg-5 m--t">
              <h3>
                ...
                <br />
                Why Choose Dynamics 365 Mixed Reality?
              </h3>

              <h4>Dynamics 365 Mixed Reality Features</h4>
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        mobile devices, headsets, and more. Allow your people to
                        create, learn, and collaborate seamlessly with the
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Optimal hardware of Mixed Reality devices equipped with
                        advanced sensor technology allows people to gain
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        headsets, personal desktops, and AR (Augmented Reality)
                        platforms to boost your user capability. Mixed Reality
                        apps demonstrate seamless compatibility with HoloLens,
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        Reality data over a secured and trusted cloud model with
                        Azure Active Directory. Businesses can safeguard their
                        vital data, monitor workloads, fix vulnerabilities, and
                        ensure Azure backup.
                      </p>
                    </div>
                  </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="side-heading">
                <h3>Dynamics 365 Mixed Reality Services</h3>
      ...
      <section className="blogs-extra">
        <div className="container">
          ...
          <div className="row top-2 gx-5">
            ...
            <div className="col-lg-6">
              <div className="blogs-extra-title">
                <h4>Mixed Reality Important Links:</h4>
              </div>
