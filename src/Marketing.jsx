            ...
            <div className="container">
               <div className="row">
                  <div className="col-lg-6 mobile-1">
                     ...
                     <h2>Automate your marketing to increase your conversion rates</h2>
                     <div>
                  ...
                  <div className="col-lg-6">
                     <img src="assets/img/marketing-banner.webp" alt="image" />
                  </div>
               </div>
            </div>
         ...
         <section>
            <div className="container">
               <header className="section-header">
                  ...
                  <p>Dynamics 365 Marketing is a marketing automation application that allows you to transform leads into fruitful <br />relationships in a more efficient and profitable way. With Dynamics 365 Marketing you will be able to tailor <br />the customer journey to your needs and transform it into a unique experience until the sale is achieved, and even beyond.</p>
               </header>
                     ...
                     <div class="accordion" id="accnew">
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Budget.svg" alt="icons" /></div><span>CORE MARKETING</span>
                                 </button>
                              </h2>
                           ...
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Financials-3.svg" alt="icons" /></div><span>EVENT MANAGEMENT</span>
                                 </button>
                              </h2>
                     ...
                     <div class="accordion" id="accnew">
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/Project.svg" alt="icons" /></div><span>FORMS PRO</span>
                                 </button>
                              </h2>
                           ...
                           <div class="accordion-item">
                              <h2 class="accordion-header" id="headingTwo">
                                 ...
                                 <div className='wr-in'><img src="assets/img/International-Accounting-3.svg" alt="icons" /></div><span>ADD-ONS</span>
                                 </button>
                              </h2>
