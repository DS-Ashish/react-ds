  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Unify your email marketing actions, customer journey, event planning, landing page experiences, lead nurturing and much more with Dynamics 365 Marketing automation."
        />
        ...
        <div className="container">
          <header className="section-header">
            ...
            <p>
              ...
              allows you to transform leads into fruitful <br />
              relationships in a more efficient and profitable way. With
              Dynamics 365 Marketing you will be able to tailor <br />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              ...
              <h4>Microsoft Dynamics 365 Finance Features</h4>
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        simplify your global financial reporting while managing
                        risks.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                  ...
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        ...
                        calculate your financial reports & statements, and boost
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Manage and simplify your global payments, ensure global
                        compliance, reduce risks, improve governance, speed up
                        your invoice delivery, comply with local tax
                        regulations.
                      </p>
                    </div>
                  </div>
