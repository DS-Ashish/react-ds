  ...
  return (
    <>
      ...
      <section>
        <div className="container">
          <header className="section-header">
            <h3>What is Power Virtual Agents?</h3>
            <p>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-power-apps_Quick-and-Easy (1).svg"
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons-power-apps_App-Development (1).svg"
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              <h3>Why choose Power Virtual Agents?</h3>
              <h4>What are Power Virtual Agents Features</h4>
                ...
                <div className="col-lg-6 top-m">
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay"></div>
                      <p>
                        Easily automate the most common common queries thanks to
                        the Power Virtual Agent chatbot.
                      </p>
                    </div>
                    <div className="why-solution-wrapper-inner">
                      <h3>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="side-heading">
                <h3>Power Virtual Agents Services</h3>
                <p>
      ...
      <section id="pricing" className="pricing">
        <div className="container">
          <header className="section-header">
            <h3>Power Virtual Agents Pricing</h3>
            <p>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                ...
                <p>
                  Talk to our Power Virtual Agents experts to schedule a free
                  demo.
                </p>
