  ...
  return (
    <>
        ...
        <div className="container">
          <header className="section-header">
            ...
            <p>
              ...
              financing to project management by <br />
              effectively leveraging Dynamics 365 Project Operations. A single
              unified app helps to bring your team together <br />
              to drive collaboration, faster your project delivery, and maximize
              your growth potentials.
            </p>
          </header>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icon-automation.svg"
                            alt="icons"
                          />
                        </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_resource-management.svg"
                            alt="icons"
                          />
                        </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_finance-management.svg"
                            alt="icons"
                          />
                        </div>
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="assets/img/icons_data-management.svg"
                            alt="icons"
                          />
                        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5 m--t">
              ...
              <h4>Microsoft Dynamics 365 Project Operations Features</h4>
                ...
                <div className="col-lg-6">
                  <div className="why-solution-wrapper">
                    <div className="why-solution-wrapper-inner">
                      ...
                      <p>
                        With Dynamics 365 Project Service Automation, assign the
                        right people to the right project leveraging
                ...
                <div className="row">
                  <div className="col-lg-8">
                    <div className="call_to_action-left">
                      ...
                      <p>
                        Connect and reveal a healthy deal for your business to
                        improve business processes and maximize business
                        capabilities.
                      </p>
      ...
      <section id="pricing" className="pricing">
        <div className="container">
          <header className="section-header">
            <h3>Dynamics 365 Project Operations Pricing</h3>
            <p>
          ...
          <div className="row gy-4 p-9">
            ...
            <div className="col-lg-6">
              <div className="box box-22">
                <h4>
                  Subsequent Dynamics 365 <br />
                  App
                </h4>
                <div className="price">
                  <sup>£</sup>22.60<span>Per-User/Per Month</span>
                </div>
                <ul>
                  <li>
                    An intelligent, automated, and trusted core financial
            ...
            <div className="col-lg-6">
              ...
              <div className="blogs-extra-right">
                <ul>
                  ...
                  <li>
                    <NavLink to="#">
                      <i className="bi bi-file-earmark-pdf"></i>New Approach to
                      Evaluating ERP
                    </NavLink>
                  </li>
                  <li>
            ...
            <div className="col-lg-8">
              <div className="accordion accordion-flush" id="faqlist1">
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Microsoft Dynamics 365 Project Operations is designed to
                      connect sales, optimize resources, manage projects, and
                      simplify finances using a single unified application that
                      helps to close deals faster and accelerate project
                      delivery while maximizing the revenue outcomes.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      When it comes to installing project operations in Dynamics
                      365, multiple deployment options come ahead. You can
                      either install Project Operations:
                      <br />
                      <br />
                      <ul>
                      ...
                      <br />
                      In the case of a new CDS environment, you need to have
                      ...
                      <br />
                      <br />
                      In the case of an existing CDS environment, you are
                      ...
                      operations.Here is the navigation:
                      <br />
                      Manage Dynamics 365 Apps-Microsoft Dynamics 365 Project
                      Operations.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      Dynamics 365 Project Operations is designed to fulfill a
                      particular purpose. It comprises its sufficient
                      capabilities to streamline and simplify project
                      management. However, you can integrate your Project
                      Operations not just with Business Central even with
                      Microsoft's other products too.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      In Microsoft Dynamics 365, each category works under the
                      category group. Hence, you need to define the group
                      categories first. Thereafter, you can create project
                      categories under the specific group. Now, let's understand
                      how to create a group category first.
                      <br />
                      <br />
                      To Create Group Category, navigate through:
                      <br />
                      <br />
                      Project Management and Accounting Setup Categories
                      Category Groups
                      <br />
                      <br />
                      After reaching to Category Group, navigate through
                      clicking New, then Category group field, and then select &
                      enter an identifier for the category group.
                      <br />
                      <br />
                      To Create a project category, navigate through:
                      <br />
                      <br />
                      Project Management and Accounting Setup Categories Project
                      Categories
                      <br />
                      <br />
                      ...
                      <br />
                      <br />
                      The last step is to select the identifier of the project
                      category.
                    </div>
                  </div>
                </div>
